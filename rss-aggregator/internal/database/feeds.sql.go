...
const creatrFeed = `-- name: CreatrFeed :one
...
func (q *Queries) CreatrFeed(ctx context.Context, arg CreatrFeedParams) (Feed, error) {
	row := q.db.QueryRowContext(ctx, creatrFeed,
		arg.ID,
		arg.CreatedAt,
		arg.UpdatedAt,
		arg.Name,
